...
const Navbar = ({ isScrolled }: NavbarProps) => (
  <header className={`fixed top-3 sm:top-6 left-0 right-0 z-50 transition-all duration-500 px-4 sm:px-0 ${isScrolled ? "top-2 sm:top-4" : ""}`}>
    <div className="max-w-5xl mx-auto">
      <div className={`backdrop-blur-xl bg-white/80 border border-gray-200 px-3 sm:px-6 py-2 sm:py-3 relative transition-all duration-500 ${isScrolled ? "shadow-2xl shadow-black/5" : ""}`}>
        ...
        <div className="flex items-center justify-between w-full gap-2 sm:gap-8">
          <div className="flex items-center gap-2 sm:gap-3">
            <Image
              ...
              height={32}
            />
            <span className="text-base sm:text-lg font-bold tracking-tight text-black">FaceGen</span>
          </div>
          ...
          <div className="ml-auto">
            <a
              ...
              className="inline-flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 rounded transition-colors"
            >
              ...
              <span className="text-xs sm:text-sm font-semibold hidden sm:inline">GitHub</span>
            </a>
          </div>
        </div>
      </div>
